...
# iaia: from dataHelper import DatasetFolder
import numpy as np
import cv2
...
# from iaia: parser.add_argument('-test_dir', nargs=1, type=str)
# from iaia: parser.add_argument('-push_dir', nargs=1, type=str)
...
# OBS! I versionen, vi har lavet, har vi samlet "train_loader", "train_dataset" osv i én "sets" istedet for at dele path op osv. 
# kig på, hvad der skal laves om her ; bliver train_push_dir og test_dir brugt i andre filer, så
batch_size = 100
########################################################
