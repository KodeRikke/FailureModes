...
# x%.t8XUM;~f-^-Q9Q2ab,uz:aHPL:nxZ
    ...
    path = "C:/Users/OhRai/Desktop/ProtoPNet-master/"
    ...
    makedir(model_dir)
    shutil.copy(src=os.path.join(path, __file__), dst=model_dir)
    shutil.copy(src=os.path.join(path, 'settings.py'), dst=model_dir)
    shutil.copy(src=os.path.join(path, base_architecture_type + '_features.py'), dst=model_dir)
    shutil.copy(src=os.path.join(path, 'model.py'), dst=model_dir)
    shutil.copy(src=os.path.join(path, 'train_and_test.py'), dst=model_dir)
