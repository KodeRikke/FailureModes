...
#########################################################################################################################
def fit(model, modelmulti, epochs, warm_epochs): # hvor kommer fit fra?
...
epoch_reached = 243 # remember it will start from 0, so it should be one + the number in the model name
ppnet, ppnet_multi = initialize_model("242nopush0.5104.pth")
