...
from dataHelper import DatasetFolder # en fil fra iaia
import numpy as np
import cv2
...
# load the data
# must use unaugmented (original) 
# 
# from ppnt: from settings import train_push_dir, test_dir
...
train_dataset = DatasetFolder( # fra iaia mappen; dataHelper.py, noget de selv har lavet?
    train_dir,
    augmentation=False,
    loader=np.load,
    extensions=("npy",),
